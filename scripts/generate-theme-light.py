...
def _generateThemeHexValues(hue1, hue2):
    ...
    lch_colors = {
        # EDITOR
        # bgs
        'bg0':          LCHabColor(105 - 10, 0, 0, obs, ill),
        'bg1':          LCHabColor(105 - 15, 0, 0, obs, ill),
        'bg2':          LCHabColor(105 - 25, 0, 0, obs, ill),
        # fgs
        'fg0':          LCHabColor(100 - 40, 15, hue2, obs, ill),
        'fg1':          LCHabColor(100 - 60, 15, hue2, obs, ill),
        'fg2':          LCHabColor(100 - 80, 15, hue2, obs, ill),
        'fg3':          LCHabColor(100 - 90, 15, hue2, obs, ill),
        # color
        'color0':       LCHabColor(100 - 50, 20, hue1, obs, ill),
        'color1':       LCHabColor(100 - 60, 50, hue1, obs, ill),
        'color2':       LCHabColor(100 - 70, 20, hue1, obs, ill),
        'color3':       LCHabColor(100 - 80, 50, hue1, obs, ill),
        # red, green, blue, orange
        'red':          LCHabColor(100 - 60, 50, 30, obs, ill),
        'orange':       LCHabColor(100 - 60, 50, 60, obs, ill),
        'green':        LCHabColor(100 - 60, 50, 150, obs, ill),
        'blue':         LCHabColor(100 - 60, 50, 270, obs, ill),
        'darkRed':      LCHabColor(100 - 20, 20, 30, obs, ill),
        'darkOrange':   LCHabColor(100 - 20, 20, 60, obs, ill),
        'darkBlue':     LCHabColor(100 - 20, 20, 270, obs, ill),

        # UI / NON-EDITOR
        'bg1.5':                LCHabColor(105 - 20, 0, 0, obs, ill),
        'bg3':                  LCHabColor(105 - 30, 0, 0, obs, ill),
        'bg3.5':                LCHabColor(105 - 40, 0, 0, obs, ill),
        'focusBorder':          LCHabColor(100 - 40, 40, hue1, obs, ill),
        'hoverBg':              LCHabColor(105 - 47, 40, hue1, obs, ill),
        'btnBadgeBg':           LCHabColor(105 - 40, 25, hue1, obs, ill),
        'btnBadgeHoverBg':      LCHabColor(105 - 47, 25, hue1, obs, ill),
        'findMatchBg':          LCHabColor(105 - 35, 25, hue1, obs, ill),
        'findMatchHlBg':        LCHabColor(105 - 25, 20, hue1, obs, ill),
        'progressBarBg':        LCHabColor(105 - 45, 50, hue1, obs, ill),
        'editorWordHlStrongBg': LCHabColor(105 - 60, 50, hue2, obs, ill),
        'black':                LCHabColor(100 - 0, 0, 0, obs, ill),

        # TERMINAL
        "term.ansiBlack":           LCHabColor(100 - 0, 0, hue2, obs, ill),
        "term.ansiRed":             LCHabColor(100 - 80, 20, hue1, obs, ill),
        "term.ansiGreen":           LCHabColor(100 - 65, 50, hue1, obs, ill),
        "term.ansiYellow":          LCHabColor(100 - 80, 50, hue1, obs, ill),
        "term.ansiBlue":            LCHabColor(100 - 50, 15, hue2, obs, ill),
        "term.ansiMagenta":         LCHabColor(100 - 50, 50, hue1, obs, ill),
        "term.ansiCyan":            LCHabColor(100 - 65, 20, hue1, obs, ill),
        "term.ansiWhite":           LCHabColor(100 - 90, 15, hue2, obs, ill),
        "term.ansiBrightBlack":     LCHabColor(100 - 50, 15, hue2, obs, ill),
        "term.ansiBrightRed":       LCHabColor(100 - 80, 20, hue1, obs, ill),
        "term.ansiBrightGreen":     LCHabColor(100 - 65, 50, hue1, obs, ill),
        "term.ansiBrightYellow":    LCHabColor(100 - 80, 50, hue1, obs, ill),
        "term.ansiBrightBlue":      LCHabColor(100 - 50, 15, hue2, obs, ill),
        "term.ansiBrightMagenta":   LCHabColor(100 - 50, 50, hue1, obs, ill),
        "term.ansiBrightCyan":      LCHabColor(100 - 65, 20, hue1, obs, ill),
        "term.ansiBrightWhite":     LCHabColor(100 - 100, 15, hue2, obs, ill),
        "term.background":          LCHabColor(105 - 10, 0, 0, obs, ill),
        "term.foreground":          LCHabColor(100 - 80, 15, hue2, obs, ill),
    }
