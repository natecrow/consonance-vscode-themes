...
def _generateThemeHexValues(hue, hue2):
    ...
    lch_colors = {
        ...
        # color
        'color0':       LCHabColor(100 - 50, 20, hue, obs, ill),
        'color1':       LCHabColor(100 - 60, 50, hue, obs, ill),
        'color2':       LCHabColor(100 - 70, 20, hue, obs, ill),
        'color3':       LCHabColor(100 - 80, 50, hue, obs, ill),
        ...
        'focusBorder':          LCHabColor(100 - 40, 40, hue, obs, ill),
        'hoverBg':              LCHabColor(105 - 47, 40, hue, obs, ill),
        'btnBadgeBg':           LCHabColor(105 - 40, 25, hue, obs, ill),
        'btnBadgeHoverBg':      LCHabColor(105 - 47, 25, hue, obs, ill),
        'findMatchBg':          LCHabColor(105 - 35, 25, hue, obs, ill),
        'findMatchHlBg':        LCHabColor(105 - 25, 20, hue, obs, ill),
        'progressBarBg':        LCHabColor(105 - 45, 50, hue, obs, ill),
        ...
        "term.ansiBlack":           LCHabColor(100 - 0, 0, 0, obs, ill),
        ...
        "term.ansiCyan":            LCHabColor(100 - 65, 20, hue, obs, ill),
        "term.ansiBrightCyan":      LCHabColor(100 - 65, 20, hue, obs, ill),
        "term.ansiGreen":           LCHabColor(100 - 65, 50, hue, obs, ill),
        "term.ansiBrightGreen":     LCHabColor(100 - 65, 50, hue, obs, ill),
        "term.ansiMagenta":         LCHabColor(100 - 50, 50, hue, obs, ill),
        "term.ansiBrightMagenta":   LCHabColor(100 - 50, 50, hue, obs, ill),
        "term.ansiRed":             LCHabColor(100 - 80, 20, hue, obs, ill),
        "term.ansiBrightRed":       LCHabColor(100 - 80, 20, hue, obs, ill),
        "term.ansiYellow":          LCHabColor(100 - 80, 50, hue, obs, ill),
        "term.ansiBrightYellow":    LCHabColor(100 - 80, 50, hue, obs, ill),
